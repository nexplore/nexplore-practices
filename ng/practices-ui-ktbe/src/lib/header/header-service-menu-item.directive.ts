...
const className =
    'text-small leading-normal font-sans font-normal inline-block no-underline h-4 my-0 outline-none after:block after:content hover:text-black';
...
@Directive({
    standalone: true,
    selector: '[puibeHeaderServiceMenuItem]',

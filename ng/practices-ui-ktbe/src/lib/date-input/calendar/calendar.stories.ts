...
import { PuibeCalendarFlyoutComponent } from './calendar-flyout.component';
...
const meta: Meta<Args> = {
    ...
    component: PuibeCalendarComponent,
    tags: ['autodocs'],
    argTypes,
    ...
    decorators: [
        moduleMetadata({
            imports: [PuibeCalendarFlyoutComponent, PuibeCalendarComponent],
        }),
    ],
    render: (args) => ({
        props: {
        ...
        <puibe-calendar 
            ...
            [min]="min"
            [max]="max"
            [hideWeekLabels]="${args.hideWeekLabels}" ></puibe-calendar>`,
    }),
};
...
export const WithFormField: Story = {
    ...
    render: (args) => ({
        ...
        template: `
        <puibe-form-field class="w-96" [formGroup]="formGroup">
            <label puibeLabel>Datepicker in form field (NOT SUPPORTED YET)</label>
            <puibe-calendar 
                [disabled]="${args.disabled}" 
                [min]="min"
                [max]="max"
                formControlName="value" ></puibe-calendar>
        </puibe-form-field>
       `,
    }),
};
...
export const Flyout: Story = {
    ...
    render: (args) => ({
        ...
        template: `
            <puibe-calendar-flyout></puibe-calendar-flyout>
       `,
    }),
};

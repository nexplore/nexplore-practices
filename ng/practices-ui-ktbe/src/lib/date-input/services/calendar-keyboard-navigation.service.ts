...
import { PuibeCalendarPeriodService, CalendarPeriodType } from './calendar-period.service';
import { PuibeCalendarYearViewService } from './calendar-year-view.service';
import { Duration } from 'date-fns/types';

@Injectable({
    providedIn: 'root',
})
export class PuibeCalendarKeyboardNavigationService {
    private _dateService = inject(DateService);
    private _calendarYearViewService = inject(PuibeCalendarYearViewService);
    private _calendarPeriodService = inject(PuibeCalendarPeriodService);

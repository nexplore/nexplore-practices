...
import { PuibeTwoColumnNavComponent } from './two-column-nav.component';

type Args = {
    heading: PuibeTwoColumnNavComponent['heading'];
    headingSelectors: PuibeTwoColumnNavComponent['headingSelectors'];
    aboveText?: string;
    belowText?: string;
};
...
const meta: Meta = {
    ...
    component: PuibeTwoColumnNavComponent,
    ...
    decorators: [
        moduleMetadata({
            imports: [PuibeTwoColumnNavComponent, BrowserAnimationsModule],
        }),
    ],
    render: (args) => ({
        props: {
        ...
        <puibe-two-column-nav [heading]="heading" [headingSelectors]="headingSelectors">

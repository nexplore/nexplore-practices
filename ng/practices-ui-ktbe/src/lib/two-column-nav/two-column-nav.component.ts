...
import { PuibeTwoColumnLayoutComponent } from '../common/two-column-container.component';
import { PuibeNavExpansionPanelComponent } from '../nav-expansion-panel/nav-expansion-panel.component';
...
@Component({
    standalone: true,
    selector: 'puibe-two-column-nav',
    templateUrl: './two-column-nav.component.html',
    imports: [PuibeTwoColumnLayoutComponent, PuibeNavExpansionPanelComponent],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PuibeTwoColumnNavComponent implements AfterViewInit {
     ...
     * @example
     * ```html
     * <puibe-two-column-nav [headingSelectors]="['h2#heading-1', 'h2#heading-2', 'h3[id]']">
     *   <div left-column>
    ...
    @ViewChild(PuibeNavExpansionPanelComponent, { static: true }) navExpansionPanel: PuibeNavExpansionPanelComponent;

    @ViewChild(PuibeTwoColumnLayoutComponent, { static: true }) twoColumnLayout: PuibeTwoColumnLayoutComponent;

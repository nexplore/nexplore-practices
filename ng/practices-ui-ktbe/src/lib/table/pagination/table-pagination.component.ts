...
import { PuibeIconArrowEndComponent } from '../../icons/icon-arrow-end.component';
import { PuibeIconArrowSlidingComponent } from '../../icons/icon-arrow-sliding.component';
import { PuibeTableComponent } from '../table.component';
import { DEFAULT_PAGE_SIZE } from './config';
import { PageService } from './page.service';
import { PuibeTablePageSizeComponent } from './table-page-size.component';
...
export class PuibeTablePaginationComponent implements OnDestroy, OnInit {
    ...
    @ContentChild(PuibeTablePageSizeComponent) _pageSizeComponent: PuibeTablePageSizeComponent;
                    ...
                    merge(
                        ...
                        new Observable(() =>
                            viewSource.queryParams$.subscribe((params) => {
                                ...
                                if (params.skip !== (this.page.current - 1) * this.page.size) {
                                    this.page.current = Math.floor(params.skip / this.page.size) + 1;
                                }
                            })
                        )
                    )

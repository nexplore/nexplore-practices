...
import { MarkControlService } from '../form/mark-control.service';
...
export class PuibeCheckboxGroupComponent implements OnDestroy {
    ...
    private readonly _checkboxesSubject = new BehaviorSubject<PuibeCheckboxComponent[]>([]);
    private readonly _checkboxes$ = this._checkboxesSubject.asObservable();

    readonly id = 'puibe-checkbox-group-' + nextUniqueId++;
     ...
     */
    registerChildCheckbox(checkbox: PuibeCheckboxComponent, _destroy$: DestroyService) {

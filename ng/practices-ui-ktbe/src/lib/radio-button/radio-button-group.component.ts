...
@Component({
    standalone: true,
    selector: 'puibe-radio-button-group',
    ...
    providers: [
        {
            ...
            multi: true,
            useExisting: forwardRef(() => PuibeRadioButtonGroupComponent),
        },
...
export class PuibeRadioButtonGroupComponent implements ControlValueAccessor, AfterViewInit {
    ...
    @ContentChildren(PuibeRadioButtonComponent, { descendants: true })
    private radioButtons: QueryList<PuibeRadioButtonComponent>;

...
@Component({
    standalone: true,
    selector: 'puibe-two-column',
    templateUrl: './two-column-container.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [NgClass],
})
export class PuibeTwoColumnLayoutComponent {
    ...
    @ViewChild('left') leftColumnContent: ElementRef<HTMLDivElement>;

    @ViewChild('right') rightColumnContent: ElementRef<HTMLDivElement>;

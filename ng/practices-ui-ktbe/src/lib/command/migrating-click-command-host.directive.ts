...
import { PuibeLegacyClickCommandDirective } from './legacy-click-command.directive';
 ...
 */
@Directive({
    selector: '[puibeMigratingClickCommandHostDirective]',
    standalone: true,
    providers: [DestroyService],
    hostDirectives: [forwardRef(() => PuibeLegacyClickCommandDirective), PuiClickCommandDirective],
})
export class PuibeMigratingClickCommandHostDirective<
    TArgs,
    TResult,
...
> {
    ...
    private readonly _legacyClickCommandDirective = inject(PuibeLegacyClickCommandDirective);

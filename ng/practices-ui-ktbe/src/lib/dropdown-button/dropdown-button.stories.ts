...
import { DropdownMenuOption, PuibeDropdownButtonComponent } from './dropdown-button.component';
...
const meta: Meta<Args> = {
    ...
    component: PuibeDropdownButtonComponent,
    tags: ['autodocs'],
    argTypes: {},
    decorators: [
        moduleMetadata({
...
export const CustomizedOptionsDropdown: Story = {
    args: {
        triggerButtonContent: `<puibe-icon-hamburger class="inline-flex" size="s"></puibe-icon-hamburger>`,
        hideArrows: true,
        size: 'large-round',
        options: customDropdownMenuOptions,
        iconTemplateConfig: { loginIconTemplate: 'puibe-icon-login', homeIconTemplate: 'puibe-icon-home' },
        clickHandlers: {

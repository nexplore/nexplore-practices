    ...
    template: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_1505_961)">
            ...
            <g clip-path="url(#clip1_1505_961)">
                <path d="M-103 -48.7815L-53 51.2185L-3 -48.7815H-103Z" stroke="currentColor" stroke-width="12" />
                <path d="M27 48.2185H127L77 -51.7815L27 48.2185Z" stroke="currentColor" stroke-width="12" />
            </g>
        </g>
        <defs>

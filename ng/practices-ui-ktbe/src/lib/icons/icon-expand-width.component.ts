...
@Component({
    standalone: true,
    selector: 'puibe-icon-expand-width',
    template: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            d="M10.0833 12H3.375L6.25 9.125"
            stroke="black"
            stroke-width="1.5"
        ...
        />
        <path
            d="M13.9167 12H20.625L17.75 9.125"
            stroke="black"
            stroke-width="1.5"
            stroke-linecap="round"
            stroke-linejoin="round"
...
export class PuibeIconExpandWidthComponent extends PuibeIconDirectiveBase {}

...
describe('isObjShallowEqual', () => {
    it('should ignore functions', () => {
        ...
        const res1 = isObjShallowEqual(a, b);
    ...
    it('should compare errors', () => {
        ...
        const res2 = isObjShallowEqual(a, b);
    ...
    it('should compare arrays', () => {
        ...
        const c = [1, 2, 6];
        const res2 = isObjShallowEqual(a, c);
        expect(res2).toBeFalsy();
    });
    ...
    it('should compare with custom comparator', () => {
        ...
        const res1 = isObjShallowEqual(a, b, undefined, (value1, value2, _key) => {
    ...
    it('should use default comparision when custom comparator returns undefined', () => {
        ...
        const res1 = isObjShallowEqual(a, b, undefined, (_value1, _value2, key) => {
            if (key === 'b') {
                return true;
            }
    ...
    it('should accept custom filter', () => {
        ...
        const res1 = isObjShallowEqual(a, b, (key) => !key.startsWith('_'));
        expect(res1).toBeTruthy();
    });

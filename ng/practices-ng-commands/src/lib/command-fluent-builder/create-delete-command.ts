 ...
 *
 * Same as `action`, but with a different status category ('action-delete').
 *
 ...
 */
export function createDeleteCommand<TArgs = void, TResult = void>(

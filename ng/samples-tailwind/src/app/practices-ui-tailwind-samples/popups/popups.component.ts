...
import {
    FLYOUT_PROVIDERS,
    MODAL_PROVIDERS,
    PracticesTailwindDialogModule,
    PuiActionDialogConfig,
    PuiActionDialogService,
...
@Component({
    ...
    imports: [PracticesTailwindDialogModule, PuiStatusHubComponent, PuiTeaserComponent],
    providers: [...MODAL_PROVIDERS, ...FLYOUT_PROVIDERS], // TODO: Normally you would probably `importProvidersFrom(PracticesTailwindDialogModule)` in the bootstrap module
})
export class AppPopupsComponent {
    ...
    openConfirmCustom = async () => {
        ...
        const customActionDialogPreset = <TResult>(
            actions: PuiDialogActionMap<typeof customActionsTemplate, TResult>,
        ): PuiActionDialogConfig<

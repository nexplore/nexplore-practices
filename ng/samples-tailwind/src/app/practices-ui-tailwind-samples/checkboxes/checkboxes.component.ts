...
import { PuiCheckboxComponent, PuiCheckboxGroupComponent } from '@nexplore/practices-ui-tailwind';
...
@Component({
    ...
    imports: [PuiCheckboxGroupComponent, PuiCheckboxComponent, FormsModule, ReactiveFormsModule],

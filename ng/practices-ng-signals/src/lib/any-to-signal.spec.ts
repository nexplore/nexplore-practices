...
describe('anyToSignal', () => {
    it('should pass through a signal', () => {
        TestBed.runInInjectionContext(() => {
            ...
            expect(results).toEqual(['is-same:true', 'initial:10', 'updated:20']);
        });
    });
    ...
    it('should convert an observable to a signal', () => {
        TestBed.runInInjectionContext(() => {
            ...
            expect(results).toEqual(['initial:undefined', 'first-update:10', 'second-update:20']);
        });
    });
    ...
    it('should convert an observable to a signal with default value', () => {
        TestBed.runInInjectionContext(() => {
            ...
            expect(results).toEqual(['initial:5', 'first-update:10', 'second-update:20']);
        });
    });
    ...
    it('should handle constant values from observables', () => {
        TestBed.runInInjectionContext(() => {
            ...
            expect(results).toEqual(['initial:42', 'after-emit:42']);
        });
    });
});

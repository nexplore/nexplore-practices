...
import { PuiSelectOptionComponent } from './select-option.component';
import { SelectViewSource } from './select-view-source';
import { PuiSelectViewSourceDirective } from './select-view-source.directive';
    ...
    render: (args) => ({
        ...
        <pui-form-field class="w-1/2" [formGroup]="formGroup">
            ...
            <ng-select
                ...
                ${args.itemSource ? '[puiSelectViewSource]="itemSource"' : ''}
...
export const WithMetadataSelect: Story = {
    render: (_) => ({
        ...
        template: `
        <pui-form-field class="w-1/2" [formGroup]="formGroup">
            <label puiLabel>With Metadata Select</label>
            <ng-select
                puiInput
                [items]="items"
                bindLabel="name"
            ...
            <ng-template ng-option-tmp let-item="item">
                <pui-select-option [item]="item" bindMetadata="category" bindLabel="name"></pui-select-option>
            </ng-template>
            </ng-select>
        </pui-form-field>`,
    }),
...
export const Grouped: Story = {
    render: (_) => ({
        ...
        template: `
        <pui-form-field class="w-1/2" [formGroup]="formGroup">
            <label puiLabel>Select with ViewSource</label>
            <ng-select
                puiInput
                [puiSelectViewSource]="itemSource"
                groupBy="category"
...
export const ReadonlyWithValue: Story = {
    render: (_) => ({
        ...
        template: `
        <pui-form-field class="w-1/2" [formGroup]="formGroup" [puiReadonly]="true">
            <label puiLabel>Readonly with value</label>
            <ng-select
                puiInput
                [items]="items"
                bindLabel="name"
...
export const ReadonlyNoValue: Story = {
    render: (_) => ({
        ...
        template: `
        <pui-form-field class="w-1/2" [formGroup]="formGroup" [puiReadonly]="true">
            <label puiLabel>Readonly with no value</label>
            <ng-select
                puiInput
                [items]="items"
                bindLabel="name"
...
export const ReadonlyMultiSelect: Story = {
    render: (_) => ({
        ...
        template: `
        <pui-form-field class="w-1/2" [formGroup]="formGroup" [puiReadonly]="true" >
            <label puiLabel>Readonly multi Select</label>
            <ng-select
                puiInput
                [items]="items"
                bindLabel="name"

...
import { PuiRadioButtonGroupComponent } from './radio-button-group.component';
...
const meta: Meta<Args> = {
    ...
    component: PuiRadioButtonGroupComponent,
    tags: ['autodocs'],
    argTypes: {
        legend: { type: 'string' },
        name: { type: 'string' },
    ...
    decorators: [
        moduleMetadata({
            imports: [PuiRadioButtonGroupComponent, PuiRadioButtonComponent, PuiReadonlyDirective],
        }),
    ],
    render: (args) => ({
        props: {
        ...
        <div [formGroup]="formGroup" class="w-full"  [puiReadonly]="readonly">
            <pui-radio-button-group class="w-full" [useSmallTextForReadonlyLabel]="useSmallTextForReadonlyLabel" [legend]="legend" [attr.name]="name" [hint]="hint" formControlName="radio" [displayInline]="displayInline" [hideGroupBorders]="hideGroupBorders" [gapVariant]="gapVariant" [hideOptional]="hideOptional" [legendAsLabel]="legendAsLabel" [readonlyEmptyValuePlaceholder]="readonlyEmptyValuePlaceholder">
                <pui-radio-button [value]="value.id" [label]="value.name" [description]="value.description" *ngFor="let value of values; index as i"></pui-radio-button>

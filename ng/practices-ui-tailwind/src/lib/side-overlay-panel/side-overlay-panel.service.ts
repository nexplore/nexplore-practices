...
import { PuiSideOverlayPanelComponent } from './side-overlay-panel.component';

export type PuiSideOverlayPanelOptions = {
    title?: string;
    titleKey?: string;
...
export class PuiSideOverlayPanelService {
    ...
    private _panelInstance: PuiSideOverlayPanelComponent | null = null;
     ...
     * - Attaches `PuiSideOverlayPanelComponent` via portal
     ...
     */
    public open(options: PuiSideOverlayPanelOptions): OverlayRef {
        ...
        const panelPortal = new ComponentPortal(PuiSideOverlayPanelComponent);
...
export const SIDE_OVERLAY_PANEL_PROVIDERS = [PuiSideOverlayPanelService];

...
import { PuiCalendarFlyoutComponent } from '../date-input/calendar/calendar-flyout.component';
import { PuiDateInputDirective } from '../date-input/date-input.directive';
...
import { PuiInputDirective } from './input.directive';
...
const meta: Meta<Args> = {
    ...
    render: (args) => {
        const input = `
            <pui-form-field [hideOptional]="${args.labelHideOptional}" 
                ${
                    args.readonlyEmptyValuePlaceholder
                        ? `[readonlyEmptyValuePlaceholder]="readonlyEmptyValuePlaceholder"`
                        : ''
                }
                [useSmallTextForReadonlyLabel]="useSmallTextForReadonlyLabel" [puiReadonly]="readonly" class="w-1/2" [formGroup]="formGroup">
                <label puiLabel [alwaysVisible]="${args.labelAlwaysVisible}">${args.label}</label>
                <input puiInput type="${args.inputType}" 

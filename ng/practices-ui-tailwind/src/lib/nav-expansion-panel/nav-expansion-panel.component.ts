...
@Component({
    standalone: true,
    selector: 'pui-nav-expansion-panel',
    templateUrl: './nav-expansion-panel.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [PuiExpansionPanelComponent, CommonModule, NgClass],
})
export class PuiNavExpansionPanelComponent implements AfterViewInit {
    ...
    @ViewChild(PuiExpansionPanelComponent, { static: true }) expansionPanel: PuiExpansionPanelComponent;

...
import { PuiIconOptionsComponent } from '../../icons/icon-options.component';

@Component({
    standalone: true,
    selector: 'pui-table-col-actions',
    templateUrl: 'table-col-actions.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [NgTemplateOutlet, PuiIconOptionsComponent, CdkMenuModule],
})
export class PuiTableColActionsComponent implements AfterViewInit {

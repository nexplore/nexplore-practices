...
import { PuiTwoColumnLayoutComponent } from './two-column-container.component';

type Args = {
    mobileOrder?: PuiTwoColumnLayoutComponent['mobileOrder'];
    horizontalDistribution?: PuiTwoColumnLayoutComponent['horizontalDistribution'];
};

const meta: Meta = {
    title: 'PUIBE/two-column',
    component: PuiTwoColumnLayoutComponent,
    ...
    decorators: [
        moduleMetadata({
            imports: [PuiTwoColumnLayoutComponent],
        }),
    ],
    render: (args) => ({
        props: {
        ...
        template: `
        <pui-two-column [mobileOrder]="mobileOrder" [horizontalDistribution]="horizontalDistribution">

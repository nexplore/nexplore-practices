...
export class PuiSBMissingTranslationHandler implements MissingTranslationHandler {
...
export const decorators: Decorator[] = [
            ...
            importProvidersFrom(
                TranslateModule.forRoot({
                    missingTranslationHandler: {
                        ...
                        useClass: PuiSBMissingTranslationHandler,
                    },
                }),
            ),
            DateService,
    ...
    componentWrapperDecorator((story) => `<pui-storybook-wrapper>${story}</pui-storybook-wrapper>`),
];

...
- [Production Releases and RC builds](https://vm-iis10.nexplore.ch/RELEASED/storybook-practices-ui-tailwind/)
- [Pre-Releases](https://vm-iis10.nexplore.ch/TESTING/storybook-practices-ui-tailwind/)
...
```bash
npm install @nexplore/practices-ui-tailwind
```

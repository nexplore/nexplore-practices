...
The library works as an addition to `Practices.CommandLine`. It contains commands and functionality to generate or manipulate code, such as executing an alphabetical sort of the content of one or multiple resx files.
